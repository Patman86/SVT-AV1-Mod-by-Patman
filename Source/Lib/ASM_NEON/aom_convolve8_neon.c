    ...
    if (h == 4) {
        ...
        if (w == 4) {
            do {
                ...
                load_u8_8x8(src + 7, src_stride, &t0, &t1, &t2, &t3, &t4, &t5, &t6, &t7);
            ...
            do {
                ...
                do {
                    ...
                    uint8x8_t d6 = convolve8_8(s6, s7, s8, s9, s10, s11, s12, s13, filter);
                    uint8x8_t d7 = convolve8_8(s7, s8, s9, s10, s11, s12, s13, s14, filter);
