...
static inline void highbd_dist_wtd_convolve_2d_horiz_8tap_sve2(const uint16_t *src, int src_stride, uint16_t *dst,
                                                               int dst_stride, int width, int height,
...
static inline void highbd_dist_wtd_convolve_2d_horiz_4tap_sve2(const uint16_t *src, int src_stride, uint16_t *dst,
                                                               int dst_stride, int width, int height,
                                                               const int16_t *x_filter_ptr, const int bd) {
...
static inline uint16x8_t highbd_convolve8_8_2d_v(int16x8_t samples_lo[4], int16x8_t samples_hi[4], int16x8_t filter,
    ...
    return vcombine_u16(vqrshrun_n_s32(sum0123, COMPOUND_ROUND1_BITS), vqrshrun_n_s32(sum4567, COMPOUND_ROUND1_BITS));
}

static inline void highbd_dist_wtd_convolve_2d_vert_8tap_sve2(const uint16_t *src, int src_stride, uint16_t *dst,
                                                              int dst_stride, int width, int height,
                                                              const int16_t *y_filter_ptr, int offset) {
    const int16x8_t y_filter   = vld1q_s16(y_filter_ptr);
    ...
    if (width == 4) {
        ...
        do {
            ...
            uint16x4_t d0 = highbd_convolve8_4_2d_v(s0123, s4567, y_filter, offset_vec);
            uint16x4_t d1 = highbd_convolve8_4_2d_v(s1234, s5678, y_filter, offset_vec);
            uint16x4_t d2 = highbd_convolve8_4_2d_v(s2345, s6789, y_filter, offset_vec);
            uint16x4_t d3 = highbd_convolve8_4_2d_v(s3456, s789A, y_filter, offset_vec);
        ...
        do {
            ...
            do {
                ...
                uint16x8_t d0 = highbd_convolve8_8_2d_v(s0123, s4567, y_filter, offset_vec);
                uint16x8_t d1 = highbd_convolve8_8_2d_v(s1234, s5678, y_filter, offset_vec);
                uint16x8_t d2 = highbd_convolve8_8_2d_v(s2345, s6789, y_filter, offset_vec);
                uint16x8_t d3 = highbd_convolve8_8_2d_v(s3456, s789A, y_filter, offset_vec);
...
static inline uint16x4_t highbd_convolve4_4_2d_v(const int16x4_t s0, const int16x4_t s1, const int16x4_t s2,
...
static inline uint16x8_t highbd_convolve4_8_2d_v(const int16x8_t s0, const int16x8_t s1, const int16x8_t s2,
...
static inline void highbd_dist_wtd_convolve_2d_vert_4tap_neon(const uint16_t *src_ptr, int src_stride,
                                                              uint16_t *dst_ptr, int dst_stride, int w, int h,
                                                              const int16_t *y_filter_ptr, const int offset) {
    ...
    if (w == 4) {
        ...
        do {
            ...
            uint16x4_t d0 = highbd_convolve4_4_2d_v(s0, s1, s2, s3, y_filter, offset_vec);
            uint16x4_t d1 = highbd_convolve4_4_2d_v(s1, s2, s3, s4, y_filter, offset_vec);
            uint16x4_t d2 = highbd_convolve4_4_2d_v(s2, s3, s4, s5, y_filter, offset_vec);
            uint16x4_t d3 = highbd_convolve4_4_2d_v(s3, s4, s5, s6, y_filter, offset_vec);
        ...
        do {
            ...
            do {
                ...
                uint16x8_t d0 = highbd_convolve4_8_2d_v(s0, s1, s2, s3, y_filter, offset_vec);
                uint16x8_t d1 = highbd_convolve4_8_2d_v(s1, s2, s3, s4, y_filter, offset_vec);
                uint16x8_t d2 = highbd_convolve4_8_2d_v(s2, s3, s4, s5, y_filter, offset_vec);
                uint16x8_t d3 = highbd_convolve4_8_2d_v(s3, s4, s5, s6, y_filter, offset_vec);
...
void svt_av1_highbd_jnt_convolve_2d_sve2(const uint16_t *src, int src_stride, uint16_t *dst, int dst_stride, int w,
                                         int h, const InterpFilterParams *filter_params_x,
                                         const InterpFilterParams *filter_params_y, const int subpel_x_qn,
                                         const int subpel_y_qn, ConvolveParams *conv_params, int bd) {
    if (h == 2 || w == 2) {
    ...
    if (x_filter_taps == 6 || y_filter_taps == 6) {
        svt_av1_highbd_jnt_convolve_2d_neon(src,
                                            src_stride,
                                            dst,
                                            dst_stride,
                                            w,
